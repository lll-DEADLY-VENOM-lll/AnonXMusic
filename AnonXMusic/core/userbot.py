    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                LOGGER(__name__).error("Assistant Account 1 has failed to access the log Group.")
            
            self.one.id = self.one.me.id
            self.one.name = self.one.me.mention
            # Username check bypass
            if not self.one.me.username:
                self.one.username = "No_Username"
            else:
        ...
        if config.STRING2:
            ...
            try:
                ...
                LOGGER(__name__).error("Assistant Account 2 has failed to access the log Group.")
            
            self.two.id = self.two.me.id
            self.two.name = self.two.me.mention
            if not self.two.me.username:
                self.two.username = "No_Username"
            else:
        ...
        if config.STRING3:
            ...
            try:
                ...
                LOGGER(__name__).error("Assistant Account 3 has failed to access the log Group.")
            
            self.three.id = self.three.me.id
            self.three.name = self.three.me.mention
            if not self.three.me.username:
                self.three.username = "No_Username"
            else:
        ...
        if config.STRING4:
            ...
            try:
                ...
                LOGGER(__name__).error("Assistant Account 4 has failed to access the log Group.")
            
            self.four.id = self.four.me.id
            self.four.name = self.four.me.mention
            if not self.four.me.username:
                self.four.username = "No_Username"
            else:
        ...
        if config.STRING5:
            ...
            try:
                ...
                LOGGER(__name__).error("Assistant Account 5 has failed to access the log Group.")
            
            self.five.id = self.five.me.id
            self.five.name = self.five.me.mention
            if not self.five.me.username:
                self.five.username = "No_Username"
            else:
